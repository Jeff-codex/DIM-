/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env editorial_preview --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 760032e81a6971d508756eeeba009c71)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DIM_WORKFLOW_ENV: "editorial_preview";
		EDITORIAL_PREVIEW_BYPASS: "enabled";
		EDITORIAL_PREVIEW_ADMIN_EMAIL: "preview-editor@depthintelligence.kr";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIM_WORKFLOW_ENV" | "EDITORIAL_PREVIEW_BYPASS" | "EDITORIAL_PREVIEW_ADMIN_EMAIL">> {}
}
