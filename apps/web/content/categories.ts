...
export const categories: Category[] = [
  {
    ...
    seoTitle: "스타트업 분석과 비즈니스 모델 변화",
    seoDescription:
      "스타트업의 제품, 운영, 비즈니스 모델이 시장과 고객 흐름을 어떻게 바꾸는지 읽는 DIM 피처 모음입니다.",
  ...
  },
  {
    ...
    seoTitle: "제품 출시 분석과 시장 전략 변화",
    seoDescription:
      "신제품과 서비스 출시가 가격, 유통, 경쟁 구도에 어떤 변화를 만드는지 읽는 DIM 피처 모음입니다.",
  ...
  },
  {
    ...
    seoTitle: "산업 구조 분석과 경쟁 질서 변화",
    seoDescription:
      "시장 구조 변화, 경쟁 질서, 운영 레이어 이동을 중심으로 산업 변화를 해석하는 DIM 피처 모음입니다.",
