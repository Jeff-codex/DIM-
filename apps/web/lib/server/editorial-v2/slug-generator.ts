...
const aliasRules: AliasRule[] = [
  ...
  { patterns: ["무신사", "musinsa"], slug: "musinsa", kind: "entity", strength: "specific" },
  ...
  { patterns: ["향수", "fragrance", "perfume"], slug: "fragrance", kind: "topic", strength: "specific" },
  { patterns: ["패션", "fashion"], slug: "fashion", kind: "topic", strength: "specific" },
  ...
  { patterns: ["확장", "expansion"], slug: "expansion", kind: "structure", strength: "specific" },
