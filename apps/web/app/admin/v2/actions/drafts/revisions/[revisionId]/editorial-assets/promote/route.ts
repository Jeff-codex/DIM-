...
import { promoteProposalAssetToEditorialV2ByRevisionId } from "@/lib/server/editorial-v2/workflow";
...
export async function POST(
  ...
  try {
    ...
    const result = await promoteProposalAssetToEditorialV2ByRevisionId(
      revisionId,
    ...
    console.error("Failed to promote v2 proposal asset by revision", error);
    const rawDetail =
